...
namespace PF_Ingenieria_Software_II.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public async Task<IActionResult> EditUsuario(Usuario objNew)
        {
            if (ModelState.IsValid)
            {
                var ObjOld = (from TablaUsuario in Context.Usuarios
                              where TablaUsuario.Id == objNew.Id
                              select TablaUsuario).Single();
                ...
                ObjOld.NombreUsuario = objNew.NombreUsuario;
                //ObjOld.Contrasena = objNew.Contrasena;

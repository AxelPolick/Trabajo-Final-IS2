...
namespace PF_Ingenieria_Software_II.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public UsuarioController(PolideportivobdContext context, IRolService rolService, IDocumentTypeService documentTypeService, IUsuarioService usuarioService)
        {
            Context = context;
                                ...
                                string nombreDocumento, string nroDocumento)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    Id = Context.Alumnos.Count() + 100 + 1,
        ...
        public IActionResult Perfil()
        {
            ...
            var usuario = _usuarioService.FindUsuario(idUsuario);

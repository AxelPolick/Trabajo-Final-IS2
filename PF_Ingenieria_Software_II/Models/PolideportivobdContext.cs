...
public partial class PolideportivobdContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.ToTable("BloqueAlumno");

            entity.Property(e => e.BloqueAlumnoId).ValueGeneratedNever();
        ...
        modelBuilder.Entity<HorarioSesion>(entity =>
        {
            ...
            entity.Property(e => e.HorarioSesionId).ValueGeneratedNever();
        ...
        {
            entity.ToTable("MatriculaBloque");

            entity.Property(e => e.MatriculaBloqueId).ValueGeneratedNever();
        ...
        {
            entity.ToTable("ModuloRol");

            entity.Property(e => e.ModuloRolId).ValueGeneratedNever();
        ...
        {
            entity.ToTable("TutorDisciplina");

            entity.Property(e => e.TutorDisciplinaId).ValueGeneratedNever();
